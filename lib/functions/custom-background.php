...
add_action( 'after_setup_theme', 'convertica_custom_background_setup', 15 );
 ...
 * @return void
 */
function convertica_custom_background_setup() {
	$defaults = array(
			'default-color'    => 'ffffff',
			'default-image'    => '',
			'wp-head-callback' => 'convertica_custom_background_callback',
		);
 ...
 * @return void
 */
function convertica_custom_background_callback() {
